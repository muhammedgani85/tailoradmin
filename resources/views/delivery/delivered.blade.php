...
@section('content')
    ...
    <thead>
        <tr class="border-y">
            ...
            <th class="px-4 py-3 text-left text-gray-500 text-sm">Delivered Date</th>

            <th class="px-4 py-3 text-left text-gray-500 text-sm">Items</th>
            <th class="px-4 py-3 text-left text-gray-500 text-sm">Status</th>
            <th class="px-4 py-3 text-left text-gray-500 text-sm">Delay Status</th>
    ...
    <tr>
        ...
        <td class="px-4 py-4">12 Apr 2026</td>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <tr class="border-t">
                            ...
                            <td>08 Apr 2026</td>
                            <td>12 Apr 2026</td>
                            <td><span class="bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full text-xs">Completed</span></td>
    ...
    <tr>
        ...
        <td class="px-4 py-4">17 Apr 2026</td>
        ...
        <td class="px-4 py-4 text-red-700">2 Days</td>
        <td class="px-4 py-4 text-right">
            <button onclick="openDeliveryModal(this)"
                class="">
                <svg class="fill-current" width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t bg-red-50">
                            ...
                            <td><span class="text-red-600">4 days</span></td>
