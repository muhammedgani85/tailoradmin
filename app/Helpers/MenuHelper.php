    ...
    public static function getMainNavItems()
    {
        return [
            [
                ...
                'subItems' => [
                    /* ['name' => 'Ecommerce', 'path' => '/'], */
                    ['name' => 'Productions', 'path' => '/taskkanban', 'pro' => false],
                ],
            ],
             [
                'icon' => 'customer',
                ...
                'subItems' => [
                    ...
                    ['name' => ' Customer Report', 'path' => '/deliverylist', 'pro' => false],
                     ...
                     ['name' => 'Tailor Performance Report ', 'path' => '/deliverytracking', 'pro' => false,'target' => '_blank'],
                      ...
                      ['name' => 'Backlog Report', 'path' => '/deliverytracking', 'pro' => false,'target' => '_blank'],
                ],
            ],
...
<path d="M3 7.5C3 6.67157 3.67157 6 4.5 6H14.5C15.3284 6 16 6.67157 16 7.5V13H17.5C17.8978 13 18.2794 13.158 18.5607 13.4393L20.5607 15.4393C20.842 15.7206 21 16.1022 21 16.5V17.5C21 18.3284 20.3284 19 19.5 19H18.5C18.5 20.1046 17.6046 21 16.5 21C15.3954 21 14.5 20.1046 14.5 19H9.5C9.5 20.1046 8.60457 21 7.5 21C6.39543 21 5.5 20.1046 5.5 19H4.5C3.67157 19 3 18.3284 3 17.5V7.5Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M16 13H18.5L20.5 15V17H16V13Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
